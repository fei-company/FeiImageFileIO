...
def printHelp():
    ...
    sys.stdout.write('-x, --cx \t<center x(px)> (required for images with a beam stopper, otional for images without a beam stopper)\n')
    sys.stdout.write('-y, --cy \t<center y(px)> (required for images with a beam stopper, otional for images without a beam stopper)\n')
